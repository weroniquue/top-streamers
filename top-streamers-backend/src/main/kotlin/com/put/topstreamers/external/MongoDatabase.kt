...
data class StreamerEntity(
    ...
    fun toDomain() = try {
        Streamer(
            id = id,
            channel = channel,
            watchTime = watchTime.toLong(),
            streamTime = streamTime.toLong(),
            peakViewers = peakViewers.toLong(),
            avgViewers = avgViewers.toLong(),
            followers = followers.toLong(),
            followersGained = followersGained.toLong(),
            viewsGained = viewsGained.toLong(),
            partnered = partnered,
            mature = mature,
            language = language
        )
